package android.wenld.recyclertest.itemTouch;
...
//		int swipeFlags = 0;
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        ...
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
            viewHolder.itemView.setBackgroundColor(viewHolder.itemView.getContext().getResources().getColor(android.wenld.recyclertest.R.color.colorPrimary));
        }
